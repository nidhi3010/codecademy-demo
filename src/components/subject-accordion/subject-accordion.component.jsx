...
export default function SubjectAccordion() {
    return (
        <div>
            <Accordion style={{ "width": "10%", "marginLeft": "17%", "backgroundColor": "#FFF0E5", "textDecoration": "none" }}>
                <AccordionSummary
                ...
                <AccordionDetails>
                    <Typography>
                        <ul className='subject-accor'>
                            ...
                            <li style={{ "listStyleType": "none", "textAlign": "left", "marginLeft": "-34%" }}><a style={{ "textDecoration": "none", "color": "#10162F", "line-height": "2" }} href="#">AI</a></li>
                            <li style={{ "listStyleType": "none", "textAlign": "left", "marginLeft": "-34%" }}><a style={{ "textDecoration": "none", "color": "#10162F", "line-height": "2" }} href="#">Data Engineering</a></li>
                            ...
                            <li style={{ "listStyleType": "none", "textAlign": "left", "marginLeft": "-34%" }}><a style={{ "textDecoration": "none", "color": "#10162F", "line-height": "2" }} href="#"></a>Foe Business</li>
                            <li style={{ "listStyleType": "none", "textAlign": "left", "marginLeft": "-34%" }}><a style={{ "textDecoration": "none", "color": "#10162F", "line-height": "2" }} href="#"></a>Beta Catalog</li>
